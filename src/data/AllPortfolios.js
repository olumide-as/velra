export const AllPortfolios = [
  {
    ...
    brief:
      "Akande & Akande, a legal firm, approached Velra for a rebrand that would position them as elite yet approachable. The brand needed to reflect legal authority without feeling dated or cold.",
    whippedUp:
  ...
  },
  {
    ...
    keywords: [
      ...
      "Velra engineering client",
      "Derby industrial web design"
    ],
  },
  {
    slug: "ime-assets",
    ...
    keywords: [
      ...
      "corporate website Derby",
      "infrastructure promotional video",
      "investment website design",
      "Velra infrastructure client",
      "Derby corporate branding"
    ],
  },
  {
    slug: "laperitum",
    ...
    keywords: [
      ...
      "social media marketing legal",
      "Velra legal client",
      "Derby law firm branding"
    ],
  },
  {
    slug: "ma-media",
  ...
  },
  {
    ...
    keywords: [
      ...
      "MMA website design",
      "sports CMS",
      "social media marketing sports",
      "Velra sports client",
      "Nigerian MMA branding"
    ],
  },
  {
    slug: "quadloop",
