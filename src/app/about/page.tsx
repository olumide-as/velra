...
//description: 'Discover Velra: where strategy meets style. We help businesses grow through intentional branding, digital creativity, and collaborative partnerships.',
//};

const About = () => {
  const images = {
    wide: "/assets/about1.jpg", // Use relative paths from public/
  ...
  return (
    <>
      <div>
        <HeroSection
          background="/assets/servicesherobg.png" // public path as string
        ...
        <section className="max-w-7xl mx-auto px-6 md:px-20 py-20 text-white bg-[#040404] space-y-20">
          <motion.section
            className="max-w-7xl mx-auto px-6 md:px-20 py-20 text-white bg-[#040404] space-y-20"
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
