    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-20">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-sm uppercase font-black text-[#DC143C] mb-3 ">Retainer Packages</h2>
          <h3 className="font-black text-2xl md:text-3xl mb-12 text-[#040404] inline-block border-b-2 border-[#DC143C] pb-1">
